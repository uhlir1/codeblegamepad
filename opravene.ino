...
int stat_RT = RELEASED;
int stat_LS = RELEASED;
int stat_RS = RELEASED;
int stat_R1 = RELEASED;
int stat_R2 = RELEASED;
int stat_R3 = RELEASED;
int stat_R4 = RELEASED;
int stat_L1 = RELEASED;
int stat_L2 = RELEASED;
int stat_L3 = RELEASED;
int stat_L4 = RELEASED;
...
void loop() {
  if (bleGamepad.isConnected()) {
    ...
    if ((digitalRead(RT) == PRESSED) and (stat_RT == RELEASED)){
      stat_RT = PRESSED;
    ...
    if ((digitalRead(RT) == RELEASED) and (stat_RT == PRESSED)){
      Serial.println(F("Right Trigger Off"));
      stat_RT = RELEASED;
      bleGamepad.release(BUTTON_8);
      bleGamepad.sendReport();
    }
    if ((digitalRead(LS) == PRESSED) and (stat_LS == RELEASED)){
      stat_LS = PRESSED;
    ...
    if ((digitalRead(LS) == RELEASED) and (stat_LS == PRESSED)){
      Serial.println(F("Left Joystick Off"));
      stat_LS = RELEASED;
      bleGamepad.release(BUTTON_14);
      bleGamepad.sendReport();
    }
    if ((digitalRead(RS) == PRESSED) and (stat_RS == RELEASED)){
      stat_RS = PRESSED;
    ...
    if ((digitalRead(RS) == RELEASED) and (stat_RS == PRESSED)){
      Serial.println(F("Right Joystick Off"));
      stat_RS = RELEASED;
      bleGamepad.release(BUTTON_15);
      bleGamepad.sendReport();
    }
    if ((digitalRead(R1) == PRESSED) and (stat_R1 == RELEASED)){
      stat_R1 = PRESSED;
    ...
    if ((digitalRead(R1) == RELEASED) and (stat_R1 == PRESSED)){
      Serial.println(F("Right Button 1 Off"));
      stat_R1 = RELEASED;
      bleGamepad.release(BUTTON_5);
      bleGamepad.sendReport();
    }
    if ((digitalRead(R2) == PRESSED) and (stat_R2 == RELEASED)){
      stat_R2 = PRESSED;
    ...
    if ((digitalRead(R2) == RELEASED) and (stat_R2 == PRESSED)){
      Serial.println(F("Right Button 2 Off"));
      stat_R2 = RELEASED;
      bleGamepad.release(BUTTON_2);
      bleGamepad.sendReport();
    }
    if ((digitalRead(R3) == PRESSED) and (stat_R3 == RELEASED)){
      stat_R3 = PRESSED;
    ...
    if ((digitalRead(R3) == RELEASED) and (stat_R3 == PRESSED)){
      Serial.println(F("Right Button 3 Off"));
      stat_R3 = RELEASED;
      bleGamepad.release(BUTTON_1);
      bleGamepad.sendReport();
    }
    if ((digitalRead(R4) == PRESSED) and (stat_R4 == RELEASED)){
      stat_R4 = PRESSED;
    ...
    if ((digitalRead(R4) == RELEASED) and (stat_R4 == PRESSED)){
    ...
    if ((digitalRead(L1) == PRESSED) and (stat_L1 == RELEASED)){
      stat_L1 = PRESSED;
    ...
    if ((digitalRead(L1) == RELEASED) and (stat_L1 == PRESSED)){
      Serial.println(F("Left Button 1 Off"));
      stat_L1 = RELEASED;
      bleGamepad.release(BUTTON_9);
      bleGamepad.sendReport();
    }
    if ((digitalRead(L2) == PRESSED) and (stat_L2 == RELEASED)){
      stat_L2 = PRESSED;
    ...
    if ((digitalRead(L2) == RELEASED) and (stat_L2 == PRESSED)){
      Serial.println(F("Left Button 2 Off"));
      stat_L2 = RELEASED;
      bleGamepad.release(BUTTON_10);
      bleGamepad.sendReport();
    }
    if ((digitalRead(L3) == PRESSED) and (stat_L3 == RELEASED)){
      stat_L3 = PRESSED;
    ...
    if ((digitalRead(L3) == RELEASED) and (stat_L3 == PRESSED)){
      Serial.println(F("Left Button 3 Off"));
      stat_L3 = RELEASED;
      bleGamepad.release(BUTTON_11);
      bleGamepad.sendReport();
    }
    if ((digitalRead(L4) == PRESSED) and (stat_L4 == RELEASED)){
      stat_L4 = PRESSED;
    ...
    if ((digitalRead(L4) == RELEASED) and (stat_L4 == PRESSED)){
